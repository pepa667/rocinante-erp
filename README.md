...
## 🛠 A Máquina sob o Capô

- **Hardware:** Raspberry Pi 3B+ (OMV7 + Docker).
- **Stack:** Next.js + MariaDB + Node.js.
- **Desenvolvimento:** Hackintosh "Frankenstein" (Hardware Chinês).
...
---
*Feito com energia líquida e determinação por Pepa.*
